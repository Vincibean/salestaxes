 ...
 * MVC workflow.
 * This Controller receives requests and serves responses concerning "about" pages.
...
class AboutController {
	...
	/**
	 * Get the web page describing the FooBar market.
	 * @return a {@link String} representing the name of the HTML page describing 
	 * the FooBar market.
	 */
	...
	/**
	 * Get the web page describing the "team" behind FooBar market application.
	 * @return a {@link String} representing the name of the HTML page describing the "team" 
	 * behind the FooBar market.
	 */
	@RequestMapping("/team")
	public String team(){
		return "about/team";
